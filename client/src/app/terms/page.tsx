    ...
    <div className="flex min-h-screen flex-col bg-[#F9F9F9]">
      ...
      <main className="flex-1 py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl bg-white p-8 sm:p-12 rounded-2xl shadow-sm border border-black/5">
          <h1 className="text-4xl font-serif font-bold text-[#063325] mb-4">ProjectLoom Terms of Service</h1>
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            <p className="text-sm text-slate-600 leading-relaxed font-medium">
              These Terms of Service ("Terms") govern your access to and use of ProjectLoom (the "Service").
              <br /><br />
              By creating an account, accessing, or using ProjectLoom, you agree to these Terms. If you do not agree with these Terms, you must not use the Service.
            </p>

            <section>
              <h2 className="text-xl font-serif font-bold text-[#063325] mb-4">1. Eligibility</h2>
              <p className="text-sm text-slate-600 leading-relaxed">
                You must be at least 18 years old, or the age of legal majority applicable in your jurisdiction, to use ProjectLoom unless applicable law permits otherwise.
                <br /><br />
                If you use ProjectLoom on behalf of a company, organization, or other legal entity, you represent that you have authority to accept these Terms on its behalf.
                <br /><br />
                You are responsible for ensuring that your use of ProjectLoom complies with all applicable laws and regulations.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Certain features of ProjectLoom require an account. Accounts may be created using supported authentication methods, including email/password and third-party authentication providers such as Google.
                <br /><br />
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                ProjectLoom is a project-management and team-collaboration platform that may provide features including:
              </p>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                "User Content" means information, files, documents, comments, tasks, messages, images, project information, profile information, and other material submitted, uploaded, created, or stored through ProjectLoom.
              </p>
              
              <h3 className="text-xl font-bold text-[#063325] mt-6 mb-2">4.1 Ownership</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                You retain ownership of your User Content. ProjectLoom does not claim ownership of your User Content.
              </p>

              <h3 className="text-xl font-bold text-[#063325] mt-6 mb-2">4.2 Permission to Operate the Service</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                By submitting User Content, you grant ProjectLoom a limited, non-exclusive, worldwide, royalty-free license to host, store, process, reproduce, transmit, and display that content only as reasonably necessary to:
              </p>
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2">
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-4">
                This does not transfer ownership of your User Content to ProjectLoom.
              </p>

              <h3 className="text-xl font-bold text-[#063325] mt-6 mb-2">4.3 Responsibility for Content</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                You are solely responsible for your User Content. You represent that you have the necessary rights and permissions to upload, store, share, or otherwise use your User Content through ProjectLoom.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                You must not use ProjectLoom to:
              </p>
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2">
                ...
                <li>Interfere with the operation or availability of ProjectLoom.</li>
                ...
                <li>Use unauthorized methods to scrape, copy, extract, or reproduce data from ProjectLoom.</li>
                <li>Use ProjectLoom to facilitate activities that could reasonably cause harm to other users or the Service.</li>
              </ul>
              <p className="text-sm text-slate-600 leading-relaxed mt-4">
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                ProjectLoom operates in accordance with applicable laws and regulations, including, where applicable, the Information Technology Act, 2000 and the Information Technology (Intermediary Guidelines and Digital Media Ethics Code) Rules, 2021, as amended from time to time.
                <br /><br />
                Where applicable to the Service, ProjectLoom may maintain and publish appropriate rules, policies, and mechanisms relating to user conduct, privacy, content restrictions, complaints, and grievance handling.
                <br /><br />
                Users are responsible for ensuring that information they upload, transmit, store, or share through ProjectLoom complies with applicable law and does not infringe the rights of others.
                <br /><br />
                ProjectLoom may restrict, remove, suspend, or otherwise take appropriate action concerning content or accounts where required by applicable law, valid legal process, or these Terms.
                <br /><br />
                Nothing in these Terms is intended to exclude or limit any mandatory obligation imposed on ProjectLoom by applicable law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                The ProjectLoom software, interface, design, branding, logos, documentation, and other materials provided by ProjectLoom are owned by or licensed to ProjectLoom and are protected by applicable intellectual-property laws.
                <br /><br />
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                ProjectLoom relies on third-party services and infrastructure to provide certain functionality. These may include authentication, hosting, storage, email, database, networking, and other infrastructure providers.
                <br /><br />
                Your use of third-party services may also be subject to their respective terms and policies.
                <br /><br />
                ProjectLoom is not responsible for failures, interruptions, changes, security incidents, or availability issues caused exclusively by third-party providers or circumstances outside our reasonable control, to the maximum extent permitted by applicable law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                We make reasonable efforts to keep ProjectLoom operational, but we do not guarantee uninterrupted availability. The Service may become unavailable because of:
              </p>
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2 grid grid-cols-2 gap-x-4">
                <li>Maintenance;</li>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                ...
                <br /><br />
                To the maximum extent permitted by applicable law, ProjectLoom does not guarantee that deleted, corrupted, lost, or inaccessible User Content will always be recoverable. This includes data loss resulting from infrastructure failures, user actions, technical failures, security incidents, or third-party services, subject to applicable law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                We implement reasonable measures intended to protect ProjectLoom and information processed through the Service. However, no internet-connected system can be guaranteed to be completely secure.
                <br /><br />
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-4">
                Nothing in these Terms constitutes a guarantee that ProjectLoom will be completely secure or immune from security incidents.
              </p>
            </section>
            ...
            <section className="bg-slate-50 p-6 rounded-xl border border-slate-100">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                To the maximum extent permitted by applicable law, ProjectLoom is provided on an "AS IS" and "AS AVAILABLE" basis.
                <br /><br />
              ...
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2 grid grid-cols-2 gap-x-4">
                <li>ProjectLoom will always be available;</li>
            ...
            <section className="bg-slate-50 p-6 rounded-xl border border-slate-100">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                To the maximum extent permitted by applicable law, ProjectLoom and its owners, operators, employees, contractors, agents, affiliates, and service providers will not be liable for indirect, incidental, special, consequential, exemplary, or punitive damages arising from or relating to your use of the Service.
                <br /><br />
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-4">
                <strong>Maximum Liability:</strong> To the maximum extent permitted by applicable law, the total aggregate liability of ProjectLoom arising from or relating to these Terms or the Service will not exceed the greater of:
                <br /><br />
                (a) the amount you paid to ProjectLoom for the Service during the twelve months preceding the event giving rise to the claim; or
                <br /><br />
                (b) INR 5,000.
                <br /><br />
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                To the maximum extent permitted by applicable law, you agree to defend, indemnify, and hold harmless ProjectLoom and its owners, operators, employees, contractors, agents, affiliates, and service providers from claims, damages, liabilities, losses, costs, and reasonable legal expenses arising from:
              </p>
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2">
              ...
              <p className="text-sm text-slate-600 leading-relaxed mt-4">
                This obligation does not apply to the extent a claim is caused by conduct for which ProjectLoom is legally responsible.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                We may suspend, restrict, or terminate access to ProjectLoom where reasonably necessary, including if:
              </p>
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2">
                <li>Your right to access ProjectLoom may immediately cease.</li>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                Your use of ProjectLoom is also subject to our Privacy Policy. The Privacy Policy explains how personal information is collected, used, stored, processed, and disclosed in connection with the Service. The Privacy Policy forms part of these Terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                To the maximum extent permitted by law, ProjectLoom will not be responsible for delays or failures caused by circumstances beyond our reasonable control. These circumstances may include:
              </p>
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2 grid grid-cols-2 gap-x-4">
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                We may modify, suspend, or discontinue any part of ProjectLoom at any time. We may introduce new features, remove existing features, change functionality, or modify technical requirements. Where reasonably appropriate, we may provide notice of material changes.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                ...
                <br /><br />
                The updated Terms will become effective on the stated effective date. Your continued use of ProjectLoom after the effective date constitutes acceptance of the updated Terms to the extent permitted by law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                These Terms are governed by the laws of India, subject to any mandatory legal rights that may apply to you. Any disputes relating to these Terms or ProjectLoom will be subject to the jurisdiction of the courts having appropriate jurisdiction under applicable Indian law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                These Terms and the Privacy Policy constitute the agreement governing your use of ProjectLoom, except where a separate written agreement applies.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                By using ProjectLoom, you agree that we may communicate with you electronically regarding:
              </p>
              <ul className="list-disc pl-5 mt-4 text-sm text-slate-600 space-y-2 grid grid-cols-2 gap-x-4">
                <li>Your account;</li>
